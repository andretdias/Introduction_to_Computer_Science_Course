...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in lowercase:
            newletterindexlow = lowercase.index(letter) + shift
            if newletterindexlow > 25:
                newletterindexlow -= 26
            newletterlow = lowercase[newletterindexlow]
            shiftdict[letter] = newletterlow
        for letter in upercase:
            newletterindexup = upercase.index(letter) + shift
            if newletterindexup > 25:
                newletterindexup -= 26
            newletterup = upercase[newletterindexup]
            shiftdict[letter] = newletterup
        return shiftdict
